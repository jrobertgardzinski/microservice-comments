...
class CorsOriginsTest {
    ...
    /** Relative to THIS MODULE's directory, which is what surefire makes the working directory. */
    private static final java.nio.file.Path MANIFEST =
            java.nio.file.Path.of("../../k8s/base/comments.yaml");
